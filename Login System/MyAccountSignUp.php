...
<header>
    ...
    <main>
        <section class="signup-form">
            ...
            <p>Already have an account? <a href="http://localhost/assignment/LogInUser.php">Log in</a></p>
        </section>
    </main>
...
// Function to handle form submission and redirect to the profile page
function submitForm() {
    const form = document.getElementById('user-form');
    if (form.checkValidity()) {
        form.submit();  // This will redirect to the PHP script for processing and then to UserProfile.php
    } else {
        alert('Please fill in all the required fields.');
    }
}
